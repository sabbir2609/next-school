...
from .views import (AttendanceCreateView, AttendanceReportView, HomeView,
                    ...
                    StudentUpdateView, StudentAutocompleteView, StudentResultCreateView, StudentResultDetailView,)
...
urlpatterns = [
    ...
    # Result URLs
    path("students/<int:pk>/result-add/", StudentResultCreateView.as_view(), name="result_add"),

    # Result Report URLs
    # students/student_id/class_name/exam_name/result-report/
    path("students/<int:student_id>/<str:class_slug>/<str:exam_slug>/result-report/", StudentResultDetailView.as_view(), name="result_report_detail"),
