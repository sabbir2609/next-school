...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Class',
            fields=[
                ('title', models.CharField(choices=[(6, 'Six'), (7, 'Seven'), (8, 'Eight'), (9, 'Nine'), (10, 'Ten')], max_length=8, primary_key=True, serialize=False)),
                ('slug', models.SlugField(blank=True, null=True, unique=True)),
                ('description', models.CharField(blank=True, default='', help_text='eg: Class 6, total 120 students, 4 sections, 30 students in each section', max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='guardian')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guardian', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='guardian', to='school.guardian')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Recommended: Upload 1:1 ratio image', null=True, upload_to='teacher_photo')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.IntegerField(default=0, unique=True, validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AddField(
            model_name='class',
            name='teacher',
            field=models.ForeignKey(blank=True, help_text='Class Teacher', null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.teacher'),
        ),
        migrations.CreateModel(
            name='StudentResult',
            fields=[
