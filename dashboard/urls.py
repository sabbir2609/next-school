...
urlpatterns = [
    ...
    path(
        "dashboard/notices/",
        DashboardNoticeListView.as_view(),
        name="notice_list",
    ),
    path(
        "dashboard/notices/<str:slug>/",
        DashboardNoticeDetailView.as_view(),
        name="notice_detail",
    ),
    path(
        "dashboard/notices/<str:slug>/update/",
        NoticeUpdateView.as_view(),
        name="notice_update",
    ),
    path(
        "dashboard/notices/<str:slug>/delete/",
